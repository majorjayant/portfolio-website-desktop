...
class SiteConfigForm(FlaskForm):
    ...
    image_about_photo1_url = StringField('Photo 1 URL', validators=[Optional(), URL()])
    image_about_photo2_url = StringField('Photo 2 URL', validators=[Optional(), URL()])
    image_about_photo3_url = StringField('Photo 3 URL', validators=[Optional(), URL()])
    image_about_photo4_url = StringField('Photo 4 URL', validators=[Optional(), URL()])
