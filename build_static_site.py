...
os.environ['IMAGE_ABOUT_PROFILE_URL'] = os.environ.get('IMAGE_ABOUT_PROFILE_URL', '/static/img/profile-photo.png')
...
about_content = {
    ...
    'profile_image': os.environ.get('IMAGE_ABOUT_PROFILE_URL', '/static/img/profile-photo.png'),
    'photos': [
