...
os.environ['IMAGE_ABOUT_PROFILE_URL'] = os.environ.get('IMAGE_ABOUT_PROFILE_URL', '/static/img/profile-photo.svg')
...
about_content = {
    ...
    'profile_image': os.environ.get('IMAGE_ABOUT_PROFILE_URL', '/static/img/profile-photo.svg'),
    'photos': [
